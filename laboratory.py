...
def end():
    ...
    print('To install the environment you need execute this script:' + "\033[1;32m"+" first_time.sh"+'\033[0;m')
    print('Example: ./first_time.sh')
    print()
    print('*You only need execute the before script the first time* <--')
    print('')
    print('When the installation ends to up the all machines you need execute:' + "\033[1;31m"+" start_laboratory.sh"+'\033[0;m')
    print('Example: ./start_laboratory.sh ')
    print()
    print('To shutdown the all machines you need execute:' + "\033[1;33m"+" shutdown_laboratory.sh"+'\033[0;m')
    print('Example: ./shutdown_laboratory.sh ')
    print()
    print('To connect to the machine "tester" you need go to directori "tester" and execute:' + "\033[1;34m"+" vagrant ssh"+'\033[0;m')
